<%-- 
    Document   : index
    Created on : Jun 1, 2019, 11:31:09 PM
    Author     : ADMIN
--%>
			...
			<nav class="navbar navbar-default">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
						...
						<li><a href="newAccount" class="scroll">Register/Đăng Ký</a></li>						
							
						<li><a href="login" class="scroll">Login/Đăng Nhập</a></li>
                                                <li><a href="loginSecurity" class="scroll">Managerment</a></li>
					</ul>  
					<div class="clearfix"> </div>	
				</div>
			</nav>    
...
<div class="w3_agile-copyright text-center">
		<p>© 2019 E-Banking. All rights reserved | Design by Phong & Nhân</p>
	</div>
<!--//footer-->	
