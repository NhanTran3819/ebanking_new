   ...
   <meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    <nav id="nav_bar">
        <ul>
            ...
            <li><a style="color: white" href="login"><marquee><p style="color: white">ebanking.com.vn &emsp; Any Time, AnyWhere&emsp;&emsp;Cho vay tiêu dùng lãi suất thấp</p></marquee></a></li>        
        </ul>
    </nav>
    </body>
</html>
